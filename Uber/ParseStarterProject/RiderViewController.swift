...
//
//  Created by Chen Shih Chia on 3/19/18.
            ...
            if userLocation.latitude != 0 && userLocation.longitude != 0 {
                ...
                riderRequest.saveInBackground(block: { (success, error) in
                    ...
                    if success {
                        ...
                        self.createAlert(title: "Could not call Uber", msg: "Please try again!")
                    }
                })
            } else {
                createAlert(title: "Could not call Uber", msg: "Cannot detect your location!")
            }
        }
                                ...
                                if let driverLocations = objects {
                                    for driverLocationObject in driverLocations {
                                        if let driverLocation = driverLocationObject["location"] as? PFGeoPoint {
                                            ...
                                            // find the distance between rider and driver
                                            ...
                                            // put both rider and driver in the map\
                                            ...
                                            // add rider and driver annotation
                                            self.map.removeAnnotations(self.map.annotations)
